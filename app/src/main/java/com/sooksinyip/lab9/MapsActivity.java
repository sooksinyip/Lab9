...
public class MapsActivity extends FragmentActivity implements GoogleMap.OnMapLongClickListener, LocationListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lMgr.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 0, 0, this);
    }
    ...
    public void onLocationChanged(Location location) {
        ...
        mMap.addMarker(new MarkerOptions().position(new LatLng(location.getLatitude(), location.getLongitude())));
        mMap.addPolyline(new PolylineOptions().add(Pre).add(new LatLng(location.getLatitude(), location.getLongitude())));
